...
comptty_icon="${data}/mac/comptty.icns"
for f in "$plist" "$comptty_icon"; do
	test -r "$f" && continue
...
icon="$comptty_icon"
version="${comptty_VERSION_MAJOR}.${comptty_VERSION_MINOR}${comptty_VERSION_PATCH}"
appversion="$comptty_VERSION"
