...
/** \mainpage CompTTY Sourcecode Interactive Doxygen Documentation : 000GIT_REVISION000
 <div align="center"><img src="fldigi-psk.png" ></div>

 \section intro Introduction

  Welcome to the CompTTY Interactive Doxygen Sourcecode Documentation!
  Here you'll find information useful for developing and debugging CompTTY. 
  
  CompTTY - Tool for comparing two RTTY text streams.


  <BR>
  \section download To Download CompTTY :
  <UL>
  <LI> To pull latest source with developer access: <B> git clone ssh://<YOUR-LOGIN>\@git.code.sf.net/p/fldigi/comptty fldigi-comptty</B></LI>
  <LI> To pull latest source with developer access behind proxy/firewall: <B> git clone https://<YOUR-LOGIN>\@git.code.sf.net/p/fldigi/comptty fldigi-comptty</B></LI>
  <LI> To pull latest source with no account, read-only: <B> git clone git://git.code.sf.net/p/fldigi/comptty fldigi-comptty</B></LI>
  </UL>
  ...
  <OL>
  <LI>Download the CompTTY sourcecode as described above</LI>
  ...
  <UL>
  <LI><A HREF="__git/">Patches for ALL git commits</A></LI>
  <LI><A HREF="__git/gitlog.txt">git-log for ALL commits</A></LI>
  </UL>
  ...
  \section license License
 	...
 	CompTTY is free software; you can redistribute it and/or modify
 	it under the terms of the GNU General Public License as published by
 	the Free Software Foundation; either version 3 of the License, or
 	(at your option) any later version.
