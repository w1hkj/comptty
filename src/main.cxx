...
#ifdef __MINGW32__
#	if COMPTEXT_FLTK_API_MAJOR == 1 && COMPTEXT_FLTK_API_MINOR < 3
#		undef dirent
#		include <dirent.h>
#	endif
#	ifndef IDI_ICON
...
int main(int argc, char **argv) 
{
	...
	make_pixmap(&comptty_icon_pixmap, comptty_icon);
	main_window->icon((char *)comptty_icon_pixmap);
	main_window->show(argc, argv);
#else
	main_window->show(argc, argv);
#endif
